import type { ChangelogEntry, ChangelogTag } from '@/lib/types';

export const TAG: Record<string, ChangelogTag> = {
...
export const FALLBACK_PRODUCT_LOG: ChangelogEntry[] = [
    {
        date: '2026-04-01',
        tag: TAG.added,
...
export const FALLBACK_DESIGN_LOG: ChangelogEntry[] = [
    {
        date: '2026-03-31',
        tag: TAG.improved,
...
export const FALLBACK_DEV_LOG: ChangelogEntry[] = [
    {
        date: '2026-03-31',
        tag: TAG.infra,
