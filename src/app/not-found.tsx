...
export default function NotFound() {
  return (
    <div className="min-h-screen  flex items-center justify-center p-6 font-mono selection:bg-bs-error/30 selection:text-bs-error">
      <div className="max-w-xl w-full">
        {/* Terminal Header */}
        <div className="border border-bs-border bg-bs-card p-4 flex items-center justify-between mb-8 overflow-hidden relative">
          <div className="flex items-center gap-3">
            <div className="w-2 h-2 rounded-full bg-bs-error animate-pulse"></div>
            <span className="text-[12px] text-bs-text-mute uppercase tracking-widest leading-none font-bold">
              Status: Critical Malfunction
            </span>
          </div>
          <div className="text-[12px] text-bs-text-mute uppercase tracking-widest leading-none font-bold">Ref: ER_VOID_404</div>
        ...
        <div className="space-y-8">
          <div className="flex items-start gap-6">
            <div className="p-4 bg-bs-error/10 border border-[#ff285a]/20 text-bs-error mt-1">
              <WifiOff size={32} />
            </div>
