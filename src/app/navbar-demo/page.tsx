            ...
            <div className="min-h-screen">
                ...
                <div className="pt-20 p-8">
                    <div className="max-w-6xl mx-auto">
                        ...
                        {/* Tooltip Demo */}
                        <section className="mb-12">
                            <h2 className="text-heading-24 text-white mb-6">4. shadcn Tooltip (Customized)</h2>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Basic Tooltip */}
                                <CardWithCornerShine padding="md">
                                    <h3 className="text-label-14 text-white mb-4">Basic Tooltip</h3>
                                    <div className="flex items-center justify-center py-8">
                                        <Tooltip>
                                            <TooltipTrigger className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-none text-white transition-colors">
                                                Hover me
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>This is a custom tooltip with glassmorphism</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </CardWithCornerShine>
                                ...
                                {/* Tooltip Positions */}
                                <CardWithCornerShine padding="md">
                                    <h3 className="text-label-14 text-white mb-4">Different Positions</h3>
                                    <div className="flex items-center justify-center gap-4 py-8">
                                        <Tooltip>
                                            <TooltipTrigger className="px-3 py-2 bg-white/10 hover:bg-white/20 rounded-none text-white text-sm transition-colors">
                                                Top
                                            </TooltipTrigger>
                                ...
                                {/* Design System Match */}
                                <CardWithCornerShine padding="md">
                                    <h3 className="text-label-14 text-white mb-4">Design System Features</h3>
                                    <div className="space-y-3 text-copy-13 text-white/70">
                                        <div className="flex items-center gap-2">
                                            <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                            <span>Border radius: <code className="text-white/90">rounded-none</code></span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                            <span>Background: <code className="text-white/90">bg-white/5 backdrop-blur-xl</code></span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                            <span>Border: <code className="text-white/90">border-white/10</code></span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span className="w-2 h-2 bg-purple-500 rounded-full"></span>
                                            <span>Text: <code className="text-white/90">text-white/80 font-sans</code></span>
                                        </div>
                                    </div>
                                </CardWithCornerShine>
                                ...
                                {/* Long Content */}
                                <CardWithCornerShine padding="md">
                                    <h3 className="text-label-14 text-white mb-4">With Longer Content</h3>
                                    <div className="flex items-center justify-center py-8">
                                        <Tooltip>
                                            <TooltipTrigger className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-none text-white transition-colors">
                                                Hover for info
                                            ...
                                            <TooltipContent className="max-w-xs">
                                                <p>This tooltip demonstrates how longer content is displayed with the glassmorphism effect and zero border-radius, matching the existing InfoTooltip design system.</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </CardWithCornerShine>
                        ...
                        <section>
                            <h2 className="text-heading-24 text-white mb-6">5. GlassmorphismNavbar</h2>
