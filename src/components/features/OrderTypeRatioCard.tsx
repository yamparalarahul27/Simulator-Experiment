      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        <div>
          <div className="flex items-center">
            <h3 className="text-[var(--bs-text-mute)] text-sm font-mono uppercase tracking-wider">Order Type Ratio</h3>
        ...
        <div className="space-y-2">
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[var(--bs-text-tertiary)] text-sm font-mono">Limit</span>
          </div>
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[var(--bs-text-tertiary)] text-sm font-mono">Market</span>
          </div>
