      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        <div>
          <div className="flex items-center">
            <h3 className="text-bs-text-mute text-sm font-mono uppercase tracking-wider">Drawdown</h3>
        ...
        <div className="space-y-3">
          <div>
            <span className="text-num-48 text-bs-error drop-shadow-[0_0_10px_rgba(248,113,113,0.25)]">
              <NumberFlow value={maxDrawdown} prefix="$" format={{ minimumFractionDigits: 2, maximumFractionDigits: 2 }} transformTiming={{ duration: 500, easing: 'ease-out' }} />
            </span>
          </div>
          <div className="text-bs-text-mute text-xs font-mono">Max peak-to-trough loss</div>
        </div>
      </div>
    </CardWithCornerShine>
  );
