        ...
        <section className="mx-auto flex max-w-6xl flex-col gap-6 md:gap-10 rounded-lg px-4 py-4 sm:p-8 text-bs-text-secondary backdrop-blur">
            ...
            <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                {[
                    ...
                    <div key={card.title} className="rounded-lg border border-bs-border bg-bs-bg/40 p-5 shadow-inner shadow-black/10">
                        <p className="text-sm uppercase tracking-[0.3em] text-bs-text-mute">{card.title}</p>
                        <p className="mt-3 text-sm leading-relaxed text-bs-text-secondary">{card.body}</p>
                    </div>
                ))}
            </div>
            ...
            <div className="space-y-4 rounded-lg bg-gradient-to-r from-[#00ffff]/15 via-[#00e6e6]/15 to-[#00b3b3]/15 p-4 md:p-6 text-sm leading-relaxed text-bs-text-primary/85">
                ...
                <div className="space-y-3 rounded-lg border border-bs-border bg-bs-bg/20 p-4 text-bs-text-secondary">
                    <p>
