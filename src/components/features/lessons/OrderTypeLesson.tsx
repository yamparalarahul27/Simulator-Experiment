            ...
            <div className="space-y-6">
                ...
                {details && details.whenToUse && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="border border-bs-border bg-white/[0.02] p-5">
                            <h3 className="text-xs font-mono uppercase tracking-wider text-bs-text-mute mb-2">When to use</h3>
                            <p className="text-sm font-mono text-bs-text-tertiary leading-relaxed">{details.whenToUse}</p>
                        </div>
                        <div className="border border-bs-border bg-white/[0.02] p-5">
                            <h3 className="text-xs font-mono uppercase tracking-wider text-orange-400/50 mb-2">Risk</h3>
                            <p className="text-sm font-mono text-bs-text-tertiary leading-relaxed">{details.risk}</p>
                        </div>
                        <div className="border border-bs-border bg-white/[0.02] p-5">
                            <h3 className="text-xs font-mono uppercase tracking-wider text-bs-brand/50 mb-2">Example</h3>
                            <p className="text-sm font-mono text-bs-text-tertiary leading-relaxed">{details.example}</p>
                        </div>
                    </div>
                )}
                ...
                <div className="flex items-center gap-3 px-4 py-3 bg-bs-brand-tertiary/5 border border-bs-brand-tertiary/15">
                    ...
                    <p className="text-xs font-mono text-bs-brand-secondary/60">
                        Use the simulator below to practice. Select <strong className="text-bs-brand-secondary/80">{lesson.title}</strong> from
