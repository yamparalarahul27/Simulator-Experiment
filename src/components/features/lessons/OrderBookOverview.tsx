...
function OverviewContent({
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="border border-[#1a1e26] bg-white/[0.02] p-6 md:p-8">
                ...
                <div className="space-y-3 text-sm font-mono text-[#adb9d2] leading-relaxed">
                    ...
                    <ul className="list-none space-y-1 pl-2">
                        <li><span className="text-[#00e66b]">Bids (buy orders)</span> — people willing to buy at certain prices or lower</li>
                        <li><span className="text-[#ff285a]">Asks (sell orders)</span> — people willing to sell at certain prices or higher</li>
                    </ul>
                    <p>
            ...
            {/* Key concepts */}
            <div className="border border-[#1a1e26] bg-white/[0.02] p-6">
                <h3 className="text-sm font-mono font-semibold text-[#ced5e4] uppercase tracking-wider mb-4">Key Concepts</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                        <h4 className="text-xs font-mono text-[#00ffff]/70 uppercase tracking-wider">Thick Book</h4>
                        <p className="text-xs font-mono text-[#585e6c]">Many orders = high liquidity = harder to move price</p>
                    </div>
                    <div className="space-y-2">
                        <h4 className="text-xs font-mono text-[#00ffff]/70 uppercase tracking-wider">Thin Book</h4>
                        <p className="text-xs font-mono text-[#585e6c]">Fewer orders = low liquidity = easier to move price</p>
                    </div>
                    <div className="space-y-2">
                        <h4 className="text-xs font-mono text-[#00ffff]/70 uppercase tracking-wider">Depth Delta</h4>
                        <p className="text-xs font-mono text-[#585e6c]">Bids − Asks = imbalance. Green = more bids, Red = more asks</p>
                    </div>
                </div>
            </div>
            ...
            {/* Depth delta example */}
            <div className="border border-[#1a1e26] bg-white/[0.02] p-6">
                <h3 className="text-sm font-mono font-semibold text-[#ced5e4] uppercase tracking-wider mb-4">Depth Delta — Worked Example</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs font-mono">
                    <div className="space-y-2">
                        <h4 className="text-[#ff285a]/80 uppercase tracking-wider">Ask Side</h4>
                        <p className="text-[#585e6c]">0–5% ask depth → 100 asks</p>
                        <p className="text-[#585e6c]">5–10% ask depth → 250 asks</p>
                        <p className="text-[#adb9d2]">Total 0–10%: <span className="text-[#ff285a]">350 asks</span></p>
                    </div>
                    <div className="space-y-2">
                        <h4 className="text-[#00e66b]/80 uppercase tracking-wider">Bid Side</h4>
                        <p className="text-[#585e6c]">0–5% bid depth → 150 bids</p>
                        <p className="text-[#585e6c]">5–10% bid depth → 400 bids</p>
                        <p className="text-[#adb9d2]">Total 0–10%: <span className="text-[#00e66b]">550 bids</span></p>
                    </div>
                </div>
                <div className="mt-4 pt-4 border-t border-[#1a1e26]">
                    <p className="text-sm font-mono text-white">
                        Depth Delta = 550 − 350 = <span className="text-[#00e66b]">+200</span>
                    </p>
