                ...
                <Popover>
                    <PopoverTrigger asChild>
                        ...
                        >
                            ...
                            <ChevronDown className="h-4 w-4 text-bs-text-tertiary" />
                        </Button>
                    </PopoverTrigger>
                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <Button
                            ...
                            className="w-full justify-between px-2.5 font-normal rounded-lg"
                        >
                            <span className="text-bs-text-secondary">
                                {selectedCount === 0
                                    ? 'All pairs'
                                    : allSelected
                    ...
                    <PopoverContent className="w-[320px] p-3" align="end">
                        <div className="flex items-center justify-between mb-3">
                            <span className="text-bs-text-tertiary text-xs font-mono uppercase tracking-wider">Select Pairs</span>
                        ...
                        <div className="max-h-[260px] overflow-auto space-y-2 pr-1">
                            {availablePairs.map((pair) => (
                                <div
                                    ...
                                    className="w-full flex items-center justify-between gap-3 px-2 py-2 rounded-lg border border-bs-border bg-bs-card hover:bg-bs-card-fg transition-colors cursor-pointer"
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <span className="text-bs-text-secondary text-sm font-mono">{pair}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
