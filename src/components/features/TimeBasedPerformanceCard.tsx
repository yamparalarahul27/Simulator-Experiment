      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center">
            <h3 className="text-bs-text-mute text-sm font-mono uppercase tracking-wider">Time-based Performance</h3>
            <InfoTooltip infoKey="timeBasedPerformance" />
          </div>

          <div className="flex items-center border border-bs-border bg-bs-bg/20">
            <button
              type="button"
        ...
        <div className="mt-6 flex-1">
          {!hasTrades ? (
            <div className="h-full flex items-center justify-center">
              <span className="text-bs-text-mute text-sm font-mono">No trades in selected period</span>
            </div>
          ) : (
        ...
        <div className="pt-4 border-t border-bs-border">
          <span className="text-bs-text-mute text-xs font-mono">PnL by {viewMode === 'session' ? 'session' : 'hour'}</span>
        </div>
      </div>
    </CardWithCornerShine>
  );
