                ...
                <div className="flex flex-col h-full space-y-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="flex items-center">
                                    <h2 className="text-xl font-bold text-[var(--bs-text-primary)] tracking-wide">PnL Analysis</h2>
                                    <InfoTooltip infoKey="pnlCard" />
                                </div>
                                <p className="text-sm text-[var(--bs-text-mute)] font-mono">NET PROFIT & LOSS</p>
                            </div>
                        </div>

                        {/* Drawdown Toggle */}
                        <div className="flex items-center gap-3">
                            <span className="text-[var(--bs-text-tertiary)] text-sm">Show Drawdown on Chart</span>
                            <button
                                onClick={() => setShowDrawdown(!showDrawdown)}
                                className={`relative inline-flex h-6 w-11 items-center rounded-lg bg-black/10 border border-[var(--bs-border)] transition-colors duration-300 ${showDrawdown ? 'bg-[var(--bs-brand-tertiary)]' : 'bg-[var(--bs-text-mute)]'
                                    }`}
                            >
                                <span
                    ...
                    <div className="flex-1 flex flex-col justify-center py-8 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
                            {/* Divider Line */}
                            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-[var(--bs-card-fg)] hidden md:block" />

                            {/* Total PnL */}
                            <div className="text-center space-y-2">
                                <span className="text-sm text-[var(--bs-text-mute)] uppercase tracking-[0.2em]">Total PnL ({activeFilter})</span>
                                <div className={`text-num-56 sm:text-num-72 tracking-normal ${pnlData.isPositive ? 'text-[var(--bs-success)]' : 'text-[var(--bs-error)]'} drop-shadow-[0_0_15px_rgba(0,0,0,0.5)]`}>
                                ...
                                {activeFilter !== 'All' && (
                                    <div className="text-center">
                                        <span className="text-[var(--bs-text-mute)] text-sm font-mono">
                            ...
                            {/* Max Drawdown */}
                            <div className="text-center space-y-2">
                                <span className="text-sm text-[var(--bs-text-mute)] uppercase tracking-[0.2em]">Max Drawdown</span>
                                <div className="text-num-56 sm:text-num-72 text-[var(--bs-error)] drop-shadow-[0_0_15px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="w-full border-t border-[var(--bs-border)] pt-4">
                        <button
                            onClick={() => setIsChartVisible(!isChartVisible)}
                            className="w-full flex items-center justify-center gap-8 group cursor-pointer"
                        >
                            <span className="text-[var(--bs-text-primary)] font-mono text-sm tracking-widest uppercase">
                                Visualisation Chart
                            </span>
                            <div className={`
                                p-1.5 rounded-full bg-[var(--bs-bg)] border border-[var(--bs-border)] 
                                group-hover:border-[var(--bs-border)] transition-all duration-300
                                ${isChartVisible ? 'rotate-180' : ''}
                            `}>
                                <ChevronDown className="w-4 h-4 text-[var(--bs-text-primary)]" />
                            </div>
                        </button>

                        {/* Drawdown Stats Table - Above Chart */}
                        {isChartVisible && showDrawdown && (
                            <div className="mt-4 p-4 bg-[var(--bs-bg)]/20 border border-[var(--bs-border)] rounded-sm animate-in fade-in slide-in-from-top-4 duration-300">
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <div className="text-[var(--bs-error)] text-num-32 font-mono">
                                        ...
                                        <div className="text-[var(--bs-text-mute)] text-xs font-mono uppercase">Max DD</div>
                                    </div>
                                    <div>
                                        <div className="text-[var(--bs-text-secondary)] text-num-32 font-mono">
                                        ...
                                        <div className="text-[var(--bs-text-mute)] text-xs font-mono uppercase">Avg Recovery</div>
                                    </div>
                                    <div>
                                        <div className="text-[var(--bs-brand)] text-num-32 font-mono">
                                        ...
                                        <div className="text-[var(--bs-text-mute)] text-xs font-mono uppercase">PnL/DD Ratio</div>
                                    </div>
                                </div>
                            </div>
                        )}
