    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex items-center justify-between mb-3">
                <span className="text-label-12 text-bs-text-tertiary uppercase tracking-wider">Price Chart</span>
                    ...
                    {timeframes.map(tf => (
                        <button
                            ...
                            className={`px-2 py-0.5 text-[10px] font-mono font-bold transition-all ${timeframe === tf
                                ...
                                : 'text-bs-text-mute hover:text-bs-text-tertiary border border-transparent'
                                }`}
                        >
                            {tf}
                        </button>
            ...
            <div className="flex-1 min-h-[300px]">
                {data.length > 0 ? (
                    ...
                    <div className="flex items-center justify-center h-full text-bs-text-mute text-xs font-mono">
