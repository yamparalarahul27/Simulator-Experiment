        ...
        <div>
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <h3 className="text-bs-text-mute text-sm font-mono uppercase tracking-wider">Journal Streak</h3>
              <InfoTooltip infoKey="tradeStreak" />
            </div>
            <span className="text-bs-brand text-[10px] font-mono border border-bs-brand-tertiary/20 px-2 py-0.5 bg-bs-brand-tertiary/5">
              <NumberFlow value={stats.activeDays} transformTiming={{ duration: 400, easing: 'ease-out' }} />/21 DAYS
            </span>
          </div>
          <p className="text-bs-text-tertiary text-xs mt-1">
