      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        <div>
          <div className="flex items-center">
            <h3 className="text-bs-text-mute text-sm font-mono uppercase tracking-wider">Average Trade Duration</h3>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {durationSegments.map(({ key, caption, digits }) => (
                <div key={key}>
                  ...
                  <div className="mt-2 text-[10px] uppercase tracking-[0.4em] text-bs-text-mute text-center">
                    {caption}
                  </div>
                </div>
              ))}
