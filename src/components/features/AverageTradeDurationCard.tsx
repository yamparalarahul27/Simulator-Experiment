      ...
      <div className="flex flex-col h-full justify-between relative z-10">
        <div>
          <div className="flex items-center">
            <h3 className="text-[var(--bs-text-mute)] text-sm font-mono uppercase tracking-wider">Average Trade Duration</h3>
          ...
          <div aria-label={durationAriaLabel}>
            <div className="grid gap-3 sm:grid-cols-3">
              {durationSegments.map(({ key, caption, digits }) => (
                <div key={key}>
                  <div
                    className="relative mt-3 flex items-center overflow-hidden rounded-lg bg-[var(--bs-bg)]/20 text-[32px] font-semibold text-[var(--bs-text-primary)]"
                  ...
                  >
                      ...
                      return (
                        <div
                          ...
                          className={`flex flex-1 justify-center px-2 py-3 ${
                            isFirst ? 'border-r border-[var(--bs-border)]' : ''
                          }`}
                        >
                          {digit}
                        </div>
                    ...
                    <span
                      className="absolute top-1/2 left-1/2 h-[8px] w-[4px] -translate-y-1/2 rounded-lg bg-white/40"
                      aria-hidden="true"
                    />
                  </div>
                  <div className="mt-2 text-[10px] uppercase tracking-[0.4em] text-[var(--bs-text-mute)] text-center">
                    {caption}
                  </div>
                </div>
              ))}
