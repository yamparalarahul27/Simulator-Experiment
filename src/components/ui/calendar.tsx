  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-8 w-8 bg-[#11141a] border border-[#1a1e26] text-white hover:bg-[#171a20] rounded-none inline-flex items-center justify-center [&_svg]:text-white [&_svg]:stroke-white"
        ),
        nav_button_previous: "",
        nav_button_next: "",
        ...
        head_row: "flex",
        head_cell:
          "text-[#585e6c] rounded-none w-9 font-mono text-[0.7rem] uppercase",
        row: "flex w-full mt-2",
        cell: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected])]:bg-[#11141a] [&:has([aria-selected])]:text-white",
        day: "h-9 w-9 p-0 font-mono text-xs rounded-none hover:bg-[#171a20]",
        day_selected:
