...
export const WelcomeFooter = ({ className = '' }: WelcomeFooterProps) => {
    return (
        ...
        `}>
            ...
            >
                <WelcomeCard className="footer-card !min-h-[auto] !py-4 w-full">
                    <div className="powered-by flex items-center justify-center space-x-4 w-full mb-2">
                        <span className="text-bs-text-mute text-sm font-mono uppercase tracking-wider">Powered by</span>
                        <img
            ...
            <motion.div
                className="attribution text-xs opacity-60 text-bs-text-secondary mt-2"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
