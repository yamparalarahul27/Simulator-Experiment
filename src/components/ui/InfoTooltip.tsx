        ...
        <TooltipProvider>
            <Tooltip delayDuration={300}>
                <TooltipTrigger asChild>
                    <button
                        type="button"
                        className={`inline-flex items-center justify-center w-5 h-5 ml-2 text-[var(--bs-text-mute)] hover:text-[var(--bs-text-secondary)] transition-colors duration-200 cursor-help ${className}`}
